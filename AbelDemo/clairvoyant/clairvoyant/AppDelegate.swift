...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func applicationWillResignActive(application: UIApplication) {
        ...
        // an incoming phone call or SMS message) or when the user quits the application and
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        // This code uses a directory named "com.luminagic.clairvoyant" in the application's
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("clairvoyant", withExtension: "momd")!
