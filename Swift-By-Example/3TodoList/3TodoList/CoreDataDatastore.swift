...
extension CoreDataDatastore {
    func addTodo(todo: Todo){
        if let managedObjectContext = managedObjectContext {
            ...
            let todoMO = NSManagedObject(entity: entity!,
                insertIntoManagedObjectContext:managedObjectContext)
            
            todoMO.setValue(todo.description, forKey: "descriptionText")
            todoMO.setValue(todo.done, forKey: "done")
            todoMO.setValue(todo.doneDate, forKey: "doneDate")
    ...
    func deleteTodo(todo: Todo){
        if let managedObjectContext = managedObjectContext {
            let fetchRequest = NSFetchRequest(entityName:"Todo")
            let predicate = NSPredicate(format: "descriptionText == %@ AND dueDate = %@",
    ...
    func addList(list: List){
        if let managedObjectContext = managedObjectContext {
            ...
            let listMO = NSManagedObject(entity: entity!,
                insertIntoManagedObjectContext:managedObjectContext)
