...
{
	//最新项目展示模块
	$.getJSON('http://61.183.87.134:8090/mobile/proList.jspx?pageSize='+pagesize+'&pageNo='+pageno, function(data) {
...
//----------------------------------------------
//推介会展示模块
//http://61.183.87.134:8090/mobile/bu.jspx?type=8&pageSize=10&pageNo=1
$.getJSON('http://182.92.107.130/mobile/bu.jspx?type=8&pageSize=10&pageNo=1', function(data) {
